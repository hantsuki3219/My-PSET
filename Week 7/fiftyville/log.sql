...
-- theft at 10:15, check transcript--
SELECT transcript FROM interviews
WHERE year = 2021 AND month = 7 AND day = 28;
--check the bakery security--
SELECT bakery_security_logs.hour, bakery_security_logs.minute, people.name, bakery_security_logs.activity, bakery_security_logs.license_plate FROM people
...
--Withness 3 less than a minute + earliest flight--
UPDATE phone_calls
...
WHERE
(
    flights.year = 2021 AND flights.month = 7 AND flights.day = 29 AND flights.id = 36
)
AND name IN
(
